...
서울시 종로구 XX동에 산다고 할 경우 회원정보 테이블에 주소 컬럼을 두고 ‘서울시 중구 XX동’을 저장해 놓으면 저장 공간이 크게 낭비됩니다. 주소는 이름이나 성별에 비해 데이터 크기가 큰데, 똑같은 데이터를 10만 건이나 저장해 갖고 있기 때문이죠.
...
[데이터베이스의 이해](https://www.slideshare.net/asukakoogy/ss-11984171)
